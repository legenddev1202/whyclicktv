...
function About() {
  return (
    <div>
      ...
      <div className="flex h-full w-full items-center justify-around absolute z-20">
        <div className="w-72 h-72 bg-black-300">IMAGE HERE</div>
        <div className="max-w-3xl flex flex-col items-center justify-center">
          <div className="text-4xl font-bold mb-8">ABOUT</div>
          <div className="text-3xl text-center leading-relaxed">
