...
function Contact() {
  return (
    <div className="relative h-full w-full" style={{ height: "100vh" }}>
      ...
      ></div>
      <div className="w-full bg-red-300 mt-20 absolute p-12 flex">
        <div className="w-1/2 p-12 bg-gray-300 pr-24 flex flex-col items-center">
          <div className="text-4xl">BUSINESS INFO</div>
        </div>
        <div className="w-1/2 p-12 bg-gray-300 pr-24"></div>
      </div>
    </div>
  );
}
