  ...
  return (
    ...
    >
      <div className="relative shadow-2xl" style={{ backgroundColor: "white" }}>
        <div
          className="absolute w-4 h-full left-0 right-0 mx-auto z-20"
          style={{ backgroundColor: "#F05A23", height: "100vh", top: -42.5 }}
        ></div>
        <div className="bg-transparent absolute h-20 flex items-center px-8 justify-between z-20">
          <div></div>
