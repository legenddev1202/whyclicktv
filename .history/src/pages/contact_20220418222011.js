...
function Contact() {
  ...
  return (
    <div className="relative h-full w-full" style={{ height: "100vh" }}>
      ...
      <div className="w-full h-11/12 mt-12 absolute p-12 flex">
        <div className="w-1/2 h-11/12 p-12 pr-24 flex flex-col items-center">
        ...
        <div
          className="w-4 h-12/12 z-10"
          style={{ backgroundColor: "#F05A23" }}
        ></div>
        <div className="w-1/2 p-12 h-11/12 pl-24 flex flex-col items-center">
          <div className="text-4xl font-bold" style={{ fontSize: 50 }}>
            QUESTIONS
          </div>
