      ...
      <div className="h-full w-full bg-slate-300">
        ...
        >
          <img
            ...
            alt="logo"
          />
          <div className="p-20 pt-36 bg-green-50">
            <div className="text-lg">773-997-8872</div>
            <div className="text-lg">Tell us your story...</div>
            <div className="text-2xl font-bold">Your Vision. Our Mission.</div>
          </div>
        </div>
      </div>
    </>
