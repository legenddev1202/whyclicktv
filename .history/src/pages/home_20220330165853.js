...
function Home() {
  return (
    <>
      ...
      <div className="w-full p-8 pl-36 flex flex-col items-center justify-center relative">
        ...
        <div className="w-60 h-96 bg-white shadow-2xl absolute left-20 -top-12 flex flex-col justify-between">
          <div></div>
          <div
            className="width-full h-14 flex items-center justify-center text-white font-bold"
            style={{ backgroundColor: "#F05A23" }}
          >
            SUBMIT
          </div>
