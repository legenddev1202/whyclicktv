...
function Home() {
  return (
    <>
      ...
      <div className="w-full height-full p-8 pl-36 flex flex-col items-center justify-center relative">
        ...
        <div className="w-60 h-full bg-white shadow-2xl absolute left-20 -top-12 flex flex-col justify-between">
          <div></div>
          <button
            className="width-full h-14 flex items-center justify-center text-white"
            style={{ backgroundColor: "#F05A23" }}
          >
            SUBMIT
          </button>
