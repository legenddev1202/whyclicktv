  ...
  return (
    <>
      ...
      <div className="w-full h-full p-8 pl-36 flex flex-col items-center justify-center relative">
        ...
        <div className="w-1/5 h-full bg-white shadow-2xl absolute left-20 -top-12 flex flex-col justify-between">
          <div className="p-8">
            <input className="border rounded-full w-full h-12 px-8"></input>
          </div>
          <button
