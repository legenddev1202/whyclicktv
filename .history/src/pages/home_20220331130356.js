...
function Home() {
  return (
    <>
      ...
      <div className="w-full h-full p-8 pl-72 flex flex-col items-center justify-center relative">
        ...
        <div
          className="bg-white shadow-2xl absolute left-20 -top-12 flex flex-col justify-between items-center"
          style={{ width: "316px", height: "500px" }}
        >
          <div className="pt-4" style={{ color: "#F05A23" }}>
            How can we help?
          </div>
          <div className="pt-4">
            <input
